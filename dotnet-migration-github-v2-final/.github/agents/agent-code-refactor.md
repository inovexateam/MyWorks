...
```
STEP 1: INVOKE skill: code-analysis TARGET: [file] MODE: deep
STEP 2: INVOKE skill: dependency-mapping TARGET: [file] MODE: nuget-only
STEP 3: INVOKE skill: pattern-recognition TARGET: [file]
STEP 4: Read all dependencies of this file before touching it
STEP 5: Check migration-checklist.md — is this file's phase open?
...
- [ ] Update migration-checklist.md status
...
Large file (>500 LOC)    → agent-complexity-decomposer (spawn)
EDMX / EF6 model        → agent-data-migrator (spawn)
```
