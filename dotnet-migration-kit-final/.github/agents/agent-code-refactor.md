...
```
STEP 1: Read .github/skills/code-analysis.md
STEP 2: Read .github/skills/dependency-mapping.md (NuGet section)
STEP 3: Read .github/skills/pattern-recognition.md
STEP 4: Read all dependencies of this file before touching it
STEP 5: Check CODEBASE-MAP.md — is this file ✅ DONE (hash match)? Skip if yes.
STEP 6: Mark file as 🔄 WIP in CODEBASE-MAP.md before starting
```
...
- [ ] Update CODEBASE-MAP.md — mark ✅ DONE with git hash
...
2. Read .github/skills/code-analysis.md
...
- Map updated: ✅ DONE with git hash
```
