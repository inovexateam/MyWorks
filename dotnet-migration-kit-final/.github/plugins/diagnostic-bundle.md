...
**Examples:**
```
Load this file when: build fails after EF Core migration in DAC
Load this file when: test fails — UserRepository.GetByIdAsync returns null
Load this file when: NullReferenceException in ProductService line 87
Load this file when: ProductList page taking 4500ms after migration
```
...
STEP 5: Verification
  After fix applied:
  Read .github/agents/agent-test-runner.md — run on affected component
