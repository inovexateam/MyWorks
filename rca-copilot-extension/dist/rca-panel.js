...
class RCAPanel {
    ...
    static show(context) {
        ...
        const panel = vscode.window.createWebviewPanel("rcaPanel", "RCA — Agent Dashboard", vscode.ViewColumn.Beside, { enableScripts: true, retainContextWhenHidden: true });
    ...
    setIncident(incident, sessionId) {
    ...
    _render() {
        this._panel.webview.html = getWebviewHTML(this._incident, this._sessionId, this._agents, this._causes);
    }
}
exports.RCAPanel = RCAPanel;
// ─── HTML ────────────────────────────────────────────────────────────────────
function getWebviewHTML(incident, sessionId, agents, causes) {
...
//# sourceMappingURL=rca-panel.js.map